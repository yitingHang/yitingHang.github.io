...
function condition(){
    ...
    condition.addEventListener('click',function(){
        ...
        content.innerHTML="<div id='text_bar'><div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>運動賽務工作執行</span></div><p id='content'>可以。有舉辦球類運動活動、參加球類比賽的經驗，平常也會觀看羽球比賽、排球比賽，對球類運動賽制進行方式清楚。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>負責活動現場的統籌與執行</span></div><p id='content'>可以。舉辦過系排系友盃的活動，對於活動的舉辦前後流程了解。包括活動前的申請場地、活動宣傳、器材籌備等等，到管理活動中的秩序，確保活動順利進行，以及活動後的場地復原等等。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>需配合假日活動出勤</span></div><p id='content'>可以，願意配合工作時間彈性活動。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>對羽球運動了解尤佳</span></div><p id='content'>可以。對羽球賽制有基礎了解，也樂意學習跟羽球相關知識。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>Microsoft Office基礎作業能力</span></div><p id='content'>可以。擅長使用Microsoft office軟體。<div id='line_center' style='margin-top:10px;'><img src='./img/warning.png' alt='warn' class='warn'><span id='title2_c'>具汽車駕照，並能實際上路</span></div><p id='content'>尚未有汽車駕照。但已報名8/29梯次駕訓班，並會努力練習，有信心順利拿取駕照。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>對運動充滿熱情，具備高抗壓性</span></div><p id='content'>可以。喜愛各項運動，喜歡具有挑戰性的工作，對於壓力有自己抒發的方式，不會為工作帶來困擾。</p></div>"
        close_is_clicked()
    })
}
