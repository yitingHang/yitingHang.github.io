...
function condition(){
    ...
    condition.addEventListener('click',function(){
        ...
        content.innerHTML="<div id='text_bar'><div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>運動賽務工作執行</span></div><p id='content'>可以，有相關經驗。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>負責活動現場的統籌與執行</span></div><p id='content'>可以，有相關經驗。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>需配合假日活動出勤</span></div><p id='content'>可以，願意配合工作活動。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>對羽球運動了解尤佳</span></div><p id='content'>對羽球有基礎了解，也樂意學習跟羽球相關知識。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>Microsoft Office基礎作業能力</span></div><p id='content'>可以，擅長使用Microsoft office軟體。<div id='line_center' style='margin-top:10px;'><img src='./img/warning.png' alt='warn' class='warn'><span id='title2_c'>具汽車駕照，並能實際上路</span></div><p id='content'>尚未有汽車駕照，但已預計報名8/22梯次駕訓班，並有信心順利拿取駕照。<div id='line_center' style='margin-top:10px;'><img src='./img/tick-mark.png' alt='yes' class='yes'><span id='title2_c'>對運動充滿熱情，具備高抗壓性</span></div><p id='content'>可以，喜愛各項運動，喜歡具有挑戰性工作。</p></div>"
        close_is_clicked()
    })
}
...
function clubEx(){
    ...
    clubEx.addEventListener('click',function(){
        ...
        content.innerHTML="<div id='text_bar'><p id='title'>【高中管樂社】</p><div id='line_center'><span id='tag'>◆</span><sapn id='title2_c'>擔任幹部：</span><span id='content'>資訊</span></div><div id='line_center'><span id='tag'>◆</span><span id='title2_c'>工作內容：</span></div><p id='content'>負責處理日常團練器材、製作送舊影片、與社團幹部共同計畫社團活動，如：迎新、送舊、慶生等等。</p><div id='line_center'><span id='tag'>◆</span><span id='title2_c'>實際經歷：</span></div><p id='content'>第一屆嘉義五校聯合音樂會、年度嘉義高商成果發表音樂會、年度音樂比賽嘉義區特優。</p><p id='title'>【大學排球系隊】</p><div id='line_center'><span id='tag'>◆</span><span id='title2_c'>擔任幹部：</span><span id='content'>隊長</span></div><div id='line_center'><span id='tag'>◆</span><span id='title2_c'>工作內容：</span></div><p id='content'>處理日常練球帶隊事務、球隊各項行政工作，如：報名比賽、協調用場時間等、計畫球隊各項活動，如：迎新、送舊、系友盃。</p><div id='line_center'><span id='tag'>◆</span><span id='title2_c'>實際經歷：</span></div><p id='content'>第15屆南資盃第三名、第14屆系友盃籌辦。</p></div>"
        close_is_clicked()
    })
}
